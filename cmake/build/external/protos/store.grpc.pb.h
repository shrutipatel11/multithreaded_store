...
class Store final {
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void getProducts(::grpc::ClientContext* context, const ::store::ProductQuery* request, ::store::ProductReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void getProducts(::grpc::ClientContext* context, const ::store::ProductQuery* request, ::store::ProductReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_getProducts : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_getProducts() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
    ...
    #endif
                     context, const ::store::ProductQuery* request, ::store::ProductReply* response) { return this->getProducts(context, request, response); }));}
    void SetMessageAllocatorFor_getProducts(
        ::grpc::experimental::MessageAllocator< ::store::ProductQuery, ::store::ProductReply>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    ~ExperimentalWithCallbackMethod_getProducts() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status getProducts(::grpc::ServerContext* /*context*/, const ::store::ProductQuery* /*request*/, ::store::ProductReply* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* getProducts(
      ::grpc::CallbackServerContext* /*context*/, const ::store::ProductQuery* /*request*/, ::store::ProductReply* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* getProducts(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::store::ProductQuery* /*request*/, ::store::ProductReply* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_getProducts<Service > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_getProducts<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_getProducts : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_getProducts() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->getProducts(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_getProducts() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status getProducts(::grpc::ServerContext* /*context*/, const ::store::ProductQuery* /*request*/, ::store::ProductReply* /*response*/) override {
